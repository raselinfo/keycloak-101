...
var utils = __webpack_require__(56954);
...
`, A = react.forwardRef(({ variant: l = "default", startIcon: o, endIcon: i, disabled: r = false, children: m, size: t = "S", href: e, to: a, ...g }, s) => {
  const c = e ? "_blank" : void 0, h = e ? "noreferrer noopener" : void 0, d = t === "S" ? 2 : "10px", p = 4;
  return (0,jsx_runtime.jsxs)(R, { ref: s, "aria-disabled": r, size: t, variant: l, target: c, rel: h, to: r ? void 0 : a, href: r ? "#" : e, background: "buttonPrimary600", borderColor: "buttonPrimary600", hasRadius: true, gap: 2, inline: true, paddingBottom: d, paddingLeft: p, paddingRight: p, paddingTop: d, pointerEvents: r ? "none" : void 0, ...g, as: a && !r ? react_router_dom/* NavLink */.OL : "a", children: [o && (0,jsx_runtime.jsx)(Flex/* Flex */.k, { "aria-hidden": true, children: o }), (0,jsx_runtime.jsx)(Typography/* Typography */.Z, { variant: t === "S" ? "pi" : void 0, fontWeight: "bold", textColor: "buttonNeutral0", children: m }), i && (0,jsx_runtime.jsx)(Flex/* Flex */.k, { "aria-hidden": true, children: i })] });
});
